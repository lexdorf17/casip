...
<a href="<?php echo $base_url;?>/Data/Galeri/<?php echo $array['Image'];?>" title="<?php echo $array['Narasi']; ?>"><img src="<?php echo $base_url;?>/Data/Galeri/<?php echo $array['Image'];?>" height="200" width="200" id="img<?php echo $i; ?>" class="img-galeri"/></a>
<img src="<?php echo $base_url; ?>/Design/images/loading_img.gif" style="padding: 65px 91px 65px 91px;border: 1px solid #CCC;" class="img-galeri" id="load<?php echo $i; ?>" />
