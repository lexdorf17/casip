...
<fieldset>
<legend>Form Suara Warga</legend>
<div class="row">
...
<div class="three columns"><img src="Lib/spam/spam.php"/></div>
</div>



<input type="submit" name="simpan" class="button small secondary" value="Kirim Pertanyaan"/>
...
<br>
<div><b>Pertanyaan :</b></div><br />
    <div id="narasi"><?php echo $array[3];?></div>
<br>
<div><b>Jawaban :</b></div><br />
<div id="narasi"><?php echo $array[5];?></div>

<p align="right" class="abu" style="font-size: 12px;"><?php echo "Diposting pada tanggal ".date("d F Y",$date).", Pukul ".$jam;?></p>
