...
$(document).ready(function(){                                                            
    ...
    $("#<?php echo date($date_format, $i); ?>2").click(function(){
        ...
        $.ajax({
            ...
            data: "mode=look&tgl=<?php echo $array['Tanggal']; ?>&bhs=ing",
...
?>
<p><a href="<?php echo $base_url; ?>/look">See All</a>
...
<div class="title"><?php echo date("F dS, Y",$month); ?>. At <?php echo $date[1]; ?></div>
<div class=""><p><?php echo $array['Note']; ?></p></div>
</div>
<?php    
}
