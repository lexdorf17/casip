...
<div style="font-size: 17px;"><strong><?php echo $judul;?></strong></div>
<span class="tsmall abu">Posted on <?php echo $tgl.". At $jam"; ?> - <?php echo $d['jumlah']; ?> Comments</span><br /><br />

	<p><?php echo $berita;?>....
<a href="<?php echo $base_url; ?>/Berita/<?php echo $array[0];?>" class="button small secondary tiny">Read More</a></p>
</div>
</div>
