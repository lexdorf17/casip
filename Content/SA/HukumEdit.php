...
<form method="post" action="Proses/EditHukum.php">
<fieldset>
<?php 
if($_GET['jeneus']=="Landasan Hukum"){
$sql    =   "select landasan_indo from content";

?>
<legend>Form Edit Landasan Hukum Indonesia</legend>
<?php
}else{
$sql    =   "select landasan_ing from content";

    ?>
<legend>Form Edit Landasan Hukum English</legend>
    <?php
}
