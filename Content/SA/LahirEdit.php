...
<form method="post" action="Proses/EditLahir.php">
<fieldset>
<?php 
if($_GET['jeneus']=="Akta Kelahiran"){
    $sql    =   "select lahir_indo from content";

?>
<legend>Form Edit Akta Kelahiran Indonesia</legend>
<?php
}else{
    $sql    =   "select lahir_ing from content";

    ?>
<legend>Form Edit Akta Kelahiran English</legend>
    <?php
}
